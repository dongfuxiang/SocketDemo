...
using SocketDemo.Sever;
using SocketDemo.Srever;
using System;
using System.IO;
using System.Text;
...
namespace SocketDemo
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            int clientIndex = this.clientComBox.SelectedIndex;
            server.SendToClient(clientIndex, MsgType.Info, textSendMsg.Text);
        }
        /// <summary>
        /// 发送文件
        /// </summary>
        ...
        private void btnSendFile_Click(object sender, RoutedEventArgs e)
        {
            ...
            server.SendToClient(clientIndex, MsgType.File, buffer);
        }
        /// <summary>
        /// 类型序列化
        /// </summary>
